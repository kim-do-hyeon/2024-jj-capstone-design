...
import com.example.blur.domain.usecase.login.FindPasswordUseCase as FindPasswordUseCase1
...
class FindPasswordViewModel @Inject constructor(
    ...
    fun onFindPasswordClick() = intent {
        ...
        result.fold(
            ...
            onFailure = { exception ->
                // 실패 시, 오류 메시지를 Toast 메시지로 보여주는 사이드 이펙트 발생
                Log.e("FindPassword", "Error finding password", exception)
            }
        )
    }
